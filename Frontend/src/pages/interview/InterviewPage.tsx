    ...
    >
      ...
      {(error || notice) && (
        <div className="px-6 pt-3 flex flex-col gap-2 shrink-0">
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-2.5 flex items-center justify-between gap-4">
              <p className="text-sm text-red-600">{error}</p>
              <button
                type="button"
                onClick={() => setError("")}
                className="text-xs text-red-500 border border-red-200 px-2.5 py-1 rounded-md shrink-0"
              >
                Dismiss
              </button>
            </div>
          ...
          {notice && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg px-4 py-2.5 flex items-center justify-between gap-4">
              <p className="text-sm text-yellow-700">{notice}</p>
              <button
                type="button"
                onClick={() => setNotice("")}
                className="text-xs text-yellow-700 border border-yellow-200 px-2.5 py-1 rounded-md shrink-0"
              >
                Dismiss
              </button>
            </div>
